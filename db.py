...
client = pymongo.MongoClient(f"mongodb+srv://ihaveread:{MONGODB_API_KEY}@cluster0.1qdqn.mongodb.net/<dbname>?retryWrites=true&w=majority")
...
# TODO: Use Google Books API
#       example: https://www.googleapis.com/books/v1/volumes?q=+isbn:9789177751304&key=GOOGLE_BOOKS_API_KEY
# TODO: Bokus  https://www.bokus.com/cgi-bin/product_search.cgi?show_advanced=1
...
# TODO: https://en.wikipedia.org/wiki/International_Standard_Book_Number#Overview
...
def validate_isbn_10():
    ...
    # Områdesbeteckning – för nationellt, geografiskt eller språkligt bestämda områden (Sverige har till exempel 91).
...
def get_data_from_isbn():
    """Used to fetch data about a book from the ISBN, either ISBN API or OpenLibrary.
    Might be placed in another .py-file for data fetching.
    """
    pass
